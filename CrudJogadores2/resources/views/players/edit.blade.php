            ...
            <div class="col-sm-12 mt-3">
                <form action="{{ route('players-update', ['id' => $player->id ]) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $player->name }}" type="text" id="name" name="name" required class="form-control" placeholder="Informe um nome para o jogador...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $player->country }}" type="text" id="country" name="country" required class="form-control" placeholder="Informe um país para o jogador...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $player->number }}" type="number" id="number" min="0" max="99" step="1" name="number" required class="form-control" placeholder="Informe um número para o jogador...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $player->position }}" type="text" id="position" name="position" required class="form-control" placeholder="Informe uma posição para o jogador...">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $player->born_at->format('Y-m-d') }}" type="date" id="born_at" name="born_at" required class="form-control" placeholder="Informe um ano para o jogador...">
                    </div>
                    <!--step="1": só aceita números inteiros-->
